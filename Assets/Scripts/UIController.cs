...
public class UIController : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (noMoney.gameObject.activeSelf)
		{
			noMoney.color -= new Color(0, 0, 0, toastFadeRate * Time.deltaTime);
			if (noMoney.color.a <= 0) noMoney.gameObject.SetActive(false);
		}
	}
